			...
			<AppContainer>
				...
				<Row>
					<Description>
						...
						to practise using and explore the web technologies React,
						Typescript, Vite and Styled Components.
					</Description>
				</Row>
				<Row>
					<Description>
						...
						you lose. If you reveal a number, that number indicates the number
						of mines around that tile. If you reveal a blank tile, all adjacent
						tiles will be revealed. Right click on a tile to flag it as a mine.
						The goal is to reveal all tiles that are not mines. Good luck!
					</Description>
				</Row>
